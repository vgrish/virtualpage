 ...
 * Update an Item
 */
class virtualpageItemUpdateProcessor extends modObjectUpdateProcessor {
	...
	public function beforeSet() {
		...
		if (empty($id)) {
			return $this->modx->lexicon('virtualpage_item_err_ns');
		}
...
return 'virtualpageItemUpdateProcessor';
